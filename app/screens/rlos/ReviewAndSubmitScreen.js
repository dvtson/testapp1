...
import { User, Phone, Money, Wallet, CheckCircle, CaretLeft } from 'phosphor-react-native';
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false} alwaysBounceVertical={true}>
        ...
        >
          ...
          <View style={styles.headerContent}>
            <Text style={styles.headerTitle}>Xác nhận hồ sơ</Text>
            <Text style={styles.headerSubtitle}>Kiểm tra lại toàn bộ thông tin</Text>
          </View>
        </LinearGradient>
