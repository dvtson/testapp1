...
import { Wallet, Bank, FileText, UploadSimple, Briefcase, CaretLeft } from 'phosphor-react-native';
...
export default function IncomeVerificationScreen({ navigation }) {
  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false} alwaysBounceVertical={true}>
        <LinearGradient
        ...
        >
          ...
          <View style={styles.headerContent}>
            <Text style={styles.headerTitle}>Thu nhập & Tài sản</Text>
            <Text style={styles.headerSubtitle}>Xác thực năng lực tài chính</Text>
          </View>
        </LinearGradient>
